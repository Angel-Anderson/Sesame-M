...
public class AntForestRpcCall {
    ...
    public static String queryEnergyRanking() {
        return queryEnergyRanking("total");
    }

    /** 按指定周期类型查询好友能量排行榜(week=周榜,total=总榜)。 */
    public static String queryEnergyRanking(String periodType) {
        return ApplicationHook.requestString("alipay.antmember.forest.h5.queryEnergyRanking", "[{\"periodType" + "\":\"" + periodType + "\",\"rankType\":\"energyRank\",\"source\":\"chInfo_ch_appcenter__chsub_9patch\"," + "\"version\":\"" + VERSION + "\"}]", "{\"pathList\":[\"friendRanking\",\"myself\"," +
                                                                                                                                                                                                                                                     "\"totalDatas\"]}");
    }
    ...
    /** 查询与好友的本周能量收取PK记录:myRecord=我收取TA的能量,targetRecord=TA收取我的能量。 */
    public static String queryPKRecord(String pkUserId) {
        return ApplicationHook.requestString("alipay.antmember.forest.h5.queryPKRecord", "[{\"pkType\":\"Week\",\"pkUser\":\"" + pkUserId + "\",\"source\":\"chInfo_ch_appcenter__chsub_9patch\"}]", "{\"pathList\":[\"targetRecord\"," +
                                                                                                                                                                                             "\"myRecord\"]}");
    }
